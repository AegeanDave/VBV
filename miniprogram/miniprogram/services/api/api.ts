...
import { submitOrder, markPaid, cancelOrder, getAllPurchasedOrders, getAllSoldOrders, hideOrder, getInstance, getOrderResult, getPurchasedOrder, getPurchasedOrderWithDealer, getSoldOrderWithCustomer, getSoldOrder, markPaidAll } from './order'
...
export {
  ...
  makeNewConnection,
  hideOrder, getSignup, getCodes, getDealer, getOrderResult, getPurchasedOrder, getPurchasedOrderWithDealer, getSoldOrderWithCustomer, getSoldOrder, deleteProduct, markPaidAll
}
